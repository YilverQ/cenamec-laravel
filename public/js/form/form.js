...
const regexInputs = {
	firts_name 	 		: /^[a-zA-ZÀ-ÿ]+$/,
	second_name 		: /^[a-zA-ZÀ-ÿ]+$/,
	lastname 			: /^[a-zA-ZÀ-ÿ]+$/,
	second_lastname 	: /^[a-zA-ZÀ-ÿ]+$/,
	...
	super_name			: /^[a-zA-ZÀ-ÿ-:;,.\s\d]+$/, 
	img 	 			: /[a-zA-Z\t\h]+|(^$)/,
	purpose 			: /[a-zA-Z\t\h:;,.]+/,
	general_objetive 	: /[a-zA-Z\t\h:;,.]+/,
	specific_objetive 	: /[a-zA-Z\t\h:;,.]+/,
	competence 			: /[a-zA-Z\t\h:;,.]+/,
	course 		 		: /^(?!Selecciona un curso$).+$/,
	description 		: /[a-zA-Z\t\h:;,]+/,
	ask					: /^[a-zA-Z\u00C0-\u00FF:;,\s\d¿?]+$/, 
	answer				: /^[a-zA-ZÀ-ÿ-:;,.\s\d]+$/, 
	bad1				: /^[a-zA-ZÀ-ÿ-:;,.\s\d]+$/, 
	bad2				: /^[a-zA-ZÀ-ÿ-:;,.\s\d]+$/, 
	bad3				: /^[a-zA-ZÀ-ÿ-:;,.\s\d]+$/, 
};
...
const messagesInputs = {
	...
	super_name			: 'No debes agregar caracteres especiales', 
	...
	ask					: 'Debes agregar un texto sin caracteres especiales', 
	answer				: 'Debes agregar un texto sin caracteres especiales', 
	bad1				: 'Debes agregar un texto sin caracteres especiales', 
	bad2				: 'Debes agregar un texto sin caracteres especiales', 
	bad3				: 'Debes agregar un texto sin caracteres especiales', 
};
