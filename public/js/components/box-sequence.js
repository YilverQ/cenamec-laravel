...
function notesDisabled (){
	notes.forEach( (note) =>{
		...
		note.classList.remove("note--right");
		note.classList.remove("note--left");
...
function changeNoteRight(key){
	notesDisabled();
	notes[key].classList.add("note--right");
	notes[key].classList.remove('note--hidden');

}

function changeNoteLeft(key){
	notesDisabled();
	notes[key].classList.add("note--left");
	notes[key].classList.remove('note--hidden');
}

function changeNoteUp(key){
	notesDisabled();
	notes[key].classList.add("note--up");
	notes[key].classList.remove('note--hidden');
}